    ...
    <section className="py-24 bg-rwandan-background-pattern">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-black mb-4">Celebration Showcase</h2>
          <p className="text-lg text-black">
            Discover beautiful events inspired by Rwandan culture, celebrating love, unity, and tradition.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {showcaseEvents.map((event, index) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="font-serif text-xl font-semibold text-gray-900 mb-3">{event.title}</h3>
                ...
                <Button variant="outline" className="w-full border-rwandan-accent text-rwandan-accent hover:bg-rwandan-light-green">
                  View Event
                </Button>
              </div>
            </div>
